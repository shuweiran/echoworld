...
## 📊 当前基线（最新汇总，2026-08-05 17:3x）

| 指标 | 值 |
|---|---|
| 测试类 | **65** |
| 测试用例 | **458（452 基线零破坏 + 新增 ImageGenerationTest 3（生图 provider 适配）+ ScriptGamePrivateChatTest +3（阶段倒计时自动推进））** |
| Failures / Errors | **0 / 0** |
| 最后全量执行 | 2026-08-05 15:0x-17:3x，**P-0805-C 主人需求「剩下的全部做完」批次三：全量 458/0 BUILD SUCCESS**（65 类 surefire 汇总，452 基线零破坏 + 6 新用例；LONG-01 单跑 PASS——首轮堆 31.1%>30% 为既有脆性 #37/#40/#41 同款；详见 v48） |
