...
|---|---|
| 测试类 | **53** |
| 测试用例 | **372（359 基线 + P-0803-F ConversationJoinTest 13）** |
| Failures / Errors | **0 / 0** |
| 最后全量执行 | 2026-08-03 13:1x（**P-0803-F 轨道系统用户加入后端原语批次：全量 372/0 BUILD SUCCESS**，53 类 surefire 汇总，LONG-01 PASS；覆盖：ConversationGroup addParticipant/removeParticipant + ConversationManager joinGroup/leaveGroup + POST /api/simulation/group/{groupId}/join·leave 端点；详见 Round 32） |
