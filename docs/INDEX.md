...
| **做 2D 渲染 / Phaser 迁移** | `docs/Phaser迁移计划.md` | `DECISION_LOG.md`（D-020）、`docs/地图JSON契约-draft.md`（阶段 0 产出） |
...
| 地图JSON契约-draft.md | 契约草案 | 08-01 13:40 | LLM 生成地图 JSON schema 草案 v1（阶段 0 产出，待未衡审查；定稿后升为 `地图JSON契约-v1.md`） |
