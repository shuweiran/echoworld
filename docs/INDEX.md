...
| **地图功能调研** | `docs/地图功能可行性调研-20260803.md`（2026-08-03：调研项 1-4 自动串联/分区域·相机·小地图/全屏/线索分配进地图 + 瓦片资产盘点 + 需求来源追溯 + 输入噪声附录） | `docs/地图JSON契约-v1.md`（契约）、`docs/Phaser迁移计划.md`（迁移决策）、DECISION_LOG D-020 |
...
| 地图功能可行性调研-20260803.md | 调研报告 | 08-03 | 地图功能四调研项（剧本生成自动串联地图 / 分区域·相机跟随·小地图 / 全屏探索 / 线索分配进地图）+ 瓦片资产盘点 + 需求来源追溯 + 逐文件输入噪声附录（P-0803-B 复核补齐） |
