...
with io.open(r"D:\roleplay-java\docs\修改记录.md", "a", encoding="utf-8") as f:
    f.write(row_226)
print("修改记录.md #226 appended")

# ---------- 2) TEST_STATUS.md 追加 v119 ----------
with io.open(r"D:\roleplay-java\TEST_STATUS.md", "r", encoding="utf-8") as f:
    ts = f.read()
...
"""
with io.open(r"D:\roleplay-java\TEST_STATUS.md", "a", encoding="utf-8") as f:
    f.write(v119)
...
with io.open(r"D:\roleplay-java\docs\并行作业登记.md", "r", encoding="utf-8") as f:
    reg = f.read()
...
with io.open(r"D:\roleplay-java\docs\并行作业登记.md", "w", encoding="utf-8") as f:
    f.write(reg)
